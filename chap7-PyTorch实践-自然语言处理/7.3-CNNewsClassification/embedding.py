...
train_file = "data/train.txt"  # 要读取的训练文本文件
orig_embedding_file = "embedding/sgns.sogou.char"  # 预训练的词嵌入向量文件，每行一个字和对应的向量值，全部用空格隔开
vocab_file = "vocab.pkl"  # 用于存储词及其id的文件
filename_trimmed_file = "embedding_SougouNews"  # 用于存储词嵌入向量的文件
